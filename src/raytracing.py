...
'''
import math
from raytracing import Camera, DirectionalLight, Plane, PointLight, Scene, Sphere, Vector3D, RayTracePanel, Triangle
from array import array
from javax.swing import JFrame, JMenuBar, JMenu, JMenuItem, JFileChooser, UIManager, ImageIcon, KeyStroke, JScrollPane, SwingUtilities
...
class Painter(Thread):
    ...
    def run(self):
        for c in self.comps: c.setEnabled(False)
        self.canvas.changeScene(self.scene)
        for c in self.comps: c.setEnabled(True)
